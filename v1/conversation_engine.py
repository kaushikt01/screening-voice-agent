    ...
    def __init__(self):
        ...
        self.conversation_topics = {
            ...
            "address": {
                ...
                "follow_ups": [
                    "Thanks. I’ll ask a quick age question next.",
                    "Perfect, thank you. Next is a quick age check.",
                    "Great. I have a quick yes/no question next."
                ],
                "contextual_questions": [
                    "Appreciate that. Shall we continue?",
                    "Thanks! Ready for the next quick question?",
                    "Got it. I’ll keep it moving."
                ]
            },
            "age": {
                "main_question": "Are you under the age of 40?",
                "variations": [
                    "Are you under the age of 40?",
                    "Just to confirm—are you younger than 40?",
                    "Quick check: are you under 40 years old?",
                    "Would you say you’re under 40?"
                ],
                "follow_ups": [
                    "Thank you. A couple more quick yes/no questions.",
                    "Great, thanks for confirming. I’ll ask about TANF next.",
                    "Perfect. Next, I’ll ask about TANF benefits."
                ],
                "contextual_questions": [
                    "Thanks. Shall we go on?",
                    "Appreciate it. I’ll keep it quick.",
                    "Got it. Moving on now."
                ]
            },
            "tanf": {
                "main_question": "Have you or anyone in your household received TANF welfare payments?",
                "variations": [
                    "Have you or anyone in your household received TANF welfare payments? You can answer ‘yes’ or ‘not applicable’.",
                    "Have you or a household member ever received TANF benefits? ‘Yes’ or ‘not applicable’ is fine.",
                    "Regarding TANF—have you or someone in your household received those payments?"
                ],
                "follow_ups": [
                    "Thank you. Next, a quick question about military service.",
                    "Got it. I’ll ask about military service next.",
                    "Thanks. Moving on to military service."
                ],
                "contextual_questions": [
            ...
            "military": {
                "main_question": "Have you served in the U.S. military?",
                "variations": [
                    "Have you served in the U.S. military?",
                    "Have you had any U.S. military service?",
                    "Did you serve in the U.S. armed forces?"
                ],
                "follow_ups": [
                    "Thanks. One last question about unemployment benefits.",
                    "Appreciate it. Final question is about unemployment compensation.",
                    "Great, thank you. Last one is about unemployment."
                ],
                "contextual_questions": [
                    "Thanks for sharing. Shall we wrap up with the last one?",
                    "Appreciate that. One final question coming up.",
                    "Got it. Just one more question."
                ]
            },
            "unemployment": {
                "main_question": "In the past year, were you unemployed and did you receive unemployment compensation for at least 27 weeks?",
                "variations": [
                    "In the past year, were you unemployed and did you receive unemployment compensation for at least 27 weeks?",
                    "During the last 12 months, did you receive unemployment benefits for 27 weeks or more?",
                    "Over the past year, did you have 27 or more weeks of unemployment compensation?"
                ],
                "follow_ups": [
                    "Thank you. That’s all I needed.",
                    "Perfect—that’s the last question. Thanks!",
        ...
        self.conversation_patterns = [
            ["name", "ssn", "address", "age", "tanf", "military", "unemployment"],
            ["name", "address", "age", "tanf", "military", "unemployment"],
            ["name", "age", "tanf", "military", "unemployment"]
        ]
